...
@section('body')
    <h3 class="page-heading">
        {{ isset($stakeholder) ? 'Edit Stakeholder' : 'Add New Stakeholder' }}
    </h3>
    ...
    <div class="py-4">
        <div class="max-w-7xl mx-auto">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-4">
                ...
                <form method="POST" action="{{ isset($stakeholder) ? route('stakeholder.update', $stakeholder->id) : route('stakeholder.store') }}">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                        <div class="">
                            ...
                            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name"
                                          value="{{isset($stakeholder) ? $stakeholder->name : old('name')}}" required autofocus
                                          autocomplete="name"/>
                        ...
                        <div class="">
                            ...
                            <x-text-input id="location" class="block mt-1 w-full" type="text" name="location"
                                          value="{{isset($stakeholder) ? $stakeholder->location : old('location')}}"
                        ...
                        <div class="">
                            ...
                            <x-text-input id="postal_address" class="block mt-1 w-full" type="text" name="postal_address"
                                          value="{{isset($stakeholder) ? $stakeholder->postal_address : old('postal_address')}}"
                        ...
                        <div class="">
                            ...
                            <x-text-input id="telephone" class="block mt-1 w-full" type="text" name="telephone"
                                          value="{{isset($stakeholder) ? $stakeholder->telephone : old('telephone')}}"
